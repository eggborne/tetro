...
pieceInfo = {
    eye:{bgSize:4,anchorPoint:[2,2],initialPositions:[[0,2],[1,2],[2,2],[3,2]],white:true},
    owe:{bgSize:2,anchorPoint:[0.5,0.5],initialPositions:[[0,0],[1,0],[0,1],[1,1]],white:true},
    tee:{bgSize:3,anchorPoint:[1,1],initialPositions:[[0,1],[1,1],[2,1],[1,2]],white:true},
    jay:{bgSize:3,anchorPoint:[1,1],initialPositions:[[0,1],[1,1],[2,1],[2,2]],white:false},
    ell:{bgSize:3,anchorPoint:[1,1],initialPositions:[[0,1],[1,1],[2,1],[0,2]],white:false,color:true},
    ess:{bgSize:3,anchorPoint:[1.5,1.5],initialPositions:[[0,2],[1,2],[1,1],[2,1]],white:false},
    zee:{bgSize:3,anchorPoint:[1.5,1.5],initialPositions:[[0,1],[1,1],[1,2],[2,2]],white:false,color:true}
}
...
$('#nameentry').html('<input length="12" maxlength="12" id="nameinput" type="text" autocomplete="off" placeholder="Enter name" name="playername"  /><button id="namesubmitbutton" class="button" type="button" >SUBMIT</button>')
...
$('#namesubmitbutton').on('click',function() {
	...
	if (currentNameEntered) {
        ...
        saveScoreToDatabase(gameName+"-"+gameMode,currentNameEntered,playerScore,true)
...
function init(firstTime) {
    ...
    playfield = new Playfield(0,playfieldY,playWidth,playHeight,"fancy",mainBorderThickness);
